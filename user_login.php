...
<head>
    ...
    <style> /* ... (Use common styles from admin_login.php) ... */
        ...
        .btn { padding: 10px 20px; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; width: 100px; text-decoration: none; display: flex; justify-content: center; align-items: center;}
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                <label>User Id</label>
                <input type="text" name="user_id" placeholder="User" required>
            </div>
            <div class="form-group">
